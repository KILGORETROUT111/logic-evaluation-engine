...
**v0.9.2.2** — Early alpha, fully working logic core with extensible primitives - Stable build: Lambda, App, Substitution Inference complete.
...
Stable build: Lambda, App, Substitution Inference complete
